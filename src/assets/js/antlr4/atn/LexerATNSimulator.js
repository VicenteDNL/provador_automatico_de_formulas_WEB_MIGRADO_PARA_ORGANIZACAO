...
var LexerNoViableAltException =
  require('./../error/Errors').LexerNoViableAltException;
...
LexerATNSimulator.prototype.matchATN = function (input) {
  ...
  if (LexerATNSimulator.debug) {
    console.log(
      'DFA after matchATN: ' + this.decisionToDFA[old_mode].toLexerString(),
    );
  }
  return predict;
};
...
LexerATNSimulator.prototype.getExistingTargetState = function (s, t) {
  ...
  if (LexerATNSimulator.debug && target !== null) {
    console.log(
      'reuse state ' + s.stateNumber + ' edge to ' + target.stateNumber,
    );
  }
  return target;
};
...
LexerATNSimulator.prototype.failOrAccept = function (
  prevAccept,
  input,
  reach,
  t,
...
// parameter.
LexerATNSimulator.prototype.getReachableConfigSet = function (
  input,
  closure,
  reach,
  t,
...
LexerATNSimulator.prototype.accept = function (
  input,
  lexerActionExecutor,
  startIndex,
  index,
...
// {@code false}.
LexerATNSimulator.prototype.closure = function (
  input,
  config,
  configs,
  currentAltReachedAcceptState,
      ...
      for (var i = 0; i < config.context.length; i++) {
        if (
          ...
          cfg = new LexerATNConfig(
            { state: returnState, context: newContext },
            config,
          );
...
LexerATNSimulator.prototype.getEpsilonTarget = function (
  input,
  config,
  trans,
  configs,
  ...
  if (trans.serializationType === Transition.RULE) {
    ...
    cfg = new LexerATNConfig(
      { state: trans.target, context: newContext },
      config,
    );
...
// {@code true}.
// /
LexerATNSimulator.prototype.evaluatePredicate = function (
  input,
  ruleIndex,
  predIndex,
  speculative,
...
LexerATNSimulator.prototype.captureSimState = function (
  settings,
  input,
  dfaState,
) {
...
LexerATNSimulator.prototype.addDFAEdge = function (from_, tk, to, cfgs) {
  ...
  // add the edge
  if (
    tk < LexerATNSimulator.MIN_DFA_EDGE ||
...
LexerATNSimulator.prototype.addDFAState = function (configs) {
  ...
  if (firstConfigWithRuleStopState !== null) {
    ...
    proposed.prediction =
      this.atn.ruleToTokenType[firstConfigWithRuleStopState.state.ruleIndex];
  }
