...
DefaultErrorStrategy.prototype.sync = function (recognizer) {
  ...
  switch (s.stateType) {
    ...
    case ATNState.STAR_LOOP_BACK:
      ...
      var whatFollowsLoopIterationOrRule = expecting.addSet(
...
//
DefaultErrorStrategy.prototype.reportNoViableAlternative = function (
  recognizer,
  e,
) {
  ...
  if (tokens !== null) {
    if (e.startToken.type === Token.EOF) {
      ...
      input = tokens.getText(
        new Interval(e.startToken.tokenIndex, e.offendingToken.tokenIndex),
      );
    }
  } else {
    input = '<unknown input>';
...
// @param e the recognition exception
//
DefaultErrorStrategy.prototype.reportFailedPredicate = function (
  recognizer,
  e,
) {
