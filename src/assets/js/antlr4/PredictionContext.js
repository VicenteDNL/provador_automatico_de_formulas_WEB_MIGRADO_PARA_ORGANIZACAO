...
PredictionContext.prototype.hasEmptyPath = function () {
  return (
    this.getReturnState(this.length - 1) ===
...
SingletonPredictionContext.prototype = Object.create(
...
function EmptyPredictionContext() {
  SingletonPredictionContext.call(
    this,
    null,
    PredictionContext.EMPTY_RETURN_STATE,
  );
...
EmptyPredictionContext.prototype = Object.create(
  SingletonPredictionContext.prototype,
);
...
ArrayPredictionContext.prototype.equals = function (other) {
  if (this === other) {
    ...
    return (
      this.returnStates === other.returnStates && this.parents === other.parents
    );
  }
};
  ...
  while (i < a.returnStates.length && j < b.returnStates.length) {
    ...
    if (a.returnStates[i] === b.returnStates[j]) {
      ...
      var bothDollars =
        ...
        b_parent === null;
      var ax_ax =
        a_parent !== null && b_parent !== null && a_parent === b_parent; // ax+ax
      // ->
      // ax
...
function getCachedPredictionContext(context, contextCache, visited) {
  ...
  for (var i = 0; i < parents.length; i++) {
    var parent = getCachedPredictionContext(
      context.getParent(i),
      contextCache,
      visited,
    );
