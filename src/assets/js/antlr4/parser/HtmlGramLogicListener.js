...
var GramLogicListener =
  require('../parser/GramLogicListener').GramLogicListener;
...
HtmlGramLogicListener.prototype.enterArg = function (ctx) {
  try {
    ...
    if (
      ...
      newText = this.xmlDoc.responseXML.createTextNode(
        clearStr[clearStr.length - 1],
      );
    ...
    if (
      ...
      switch (conect) {
        ...
        case '->':
          ...
          newElementPrim =
            this.xmlDoc.responseXML.createElement('ANTECENDENTE');
          newElementPrim.appendChild(left.value);
          newElement.appendChild(newElementPrim);
