var gramLogic = (function () {
  ...
  return {
    validar: function (formula, prod = 'false') {
      ...
      var GramLogicLexer =
        require('assets/js/antlr4/parser/GramLogicLexer').GramLogicLexer;
      var GramLogicParser =
        require('assets/js/antlr4/parser/GramLogicParser').GramLogicParser;
      var HtmlErrorListener =
        require('assets/js/antlr4/parser/HtmlErrorListener').HtmlErrorListener;
      var HtmlGramLogicListener =
        require('assets/js/antlr4/parser/HtmlGramLogicListener').HtmlGramLogicListener;
        ...
        for (var i = 0; i < errorListener.errors.length; i++) {
          ...
          if (error.msg.indexOf('expecting') >= 0) {
            ...
            if (entrada == '~') {
              ...
              infos.push(
                "Valor esperado: Simbolo de negação '~' Letras predicativas de 'A' a 'Z'",
              );
            } else {
